...
/**
 * Create by  zhangbaowei on 2018/8/21 13:02.
 */
...
public class RedisClientImplTest {
    ...
    public void ping() {
        ...
        boolean ping = redisClient.ping();
        System.out.println(ping);

        assertTrue(ping);
//        redisManager.get("aaa");
    }

    @Test
    public void testAll_() {
        Point p = new Point();
        p.setX(1);
        p.setY(2);
        ...
        Map<String, Point> all = redisClient.getAll(Arrays.asList("all:1", "kongkong", "all:2", "all:notexist"), new TypeReference<Point>() {
        });

        for (Map.Entry<String, Point> stringPointEntry : all.entrySet()) {
    ...
    //     getExpire(String key, final TimeUnit timeUnit);
//
//    Long getExpire(String key);
    ...
    @Test
    public void getSortedEntryValues() {
    }
    ...
    @Test
    public void scanAllHashEntries() {
    }
    ...
    @Test
    public void getAllItemsFromSet() {
    }
    ...
    @Test
    public void popItemFromSet() {
    }

    @Test
    public void popItemsFromSet() {
    }

    @Test
    public void moveBetweenSets() {
    }
